...
const { getAddProductPage, postAddProductPage, getAdminProductsPage, getEditProductPage, postEditProductPage, postDeleteProductPage, getLoginPage } = require('../controllers/admin/ProductController');
